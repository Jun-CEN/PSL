...
RESULT_FILES=("results_ft_mit/TSM_openmax_ft_MiT.npz" \  # openmax
              ...
              "results_ft_mit/TSM_PSL_80_n_s_shu_ft_mit_score.npz")       # PSL (ours)
THRESHOLDS=(0.1 \
            0.000022 \
            0.000003 \
            0.999683 \
...
python experiments/compare_openness_new_mit.py \
    --base_model tsm \
    --ood_data ${OOD_DATA} \
